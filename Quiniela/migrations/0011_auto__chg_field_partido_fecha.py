...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partido.fecha'
        db.alter_column(u'Quiniela_partido', 'fecha', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Partido.fecha'
        db.alter_column(u'Quiniela_partido', 'fecha', self.gf('django.db.models.fields.DateField')())
