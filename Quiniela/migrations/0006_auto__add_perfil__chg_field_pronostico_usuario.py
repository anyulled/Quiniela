...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Perfil'
        db.create_table(u'Quiniela_perfil', (
        ...
        db.send_create_signal(u'Quiniela', ['Perfil'])


        # Changing field 'Pronostico.usuario'
        db.alter_column(u'Quiniela_pronostico', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'Perfil'
        db.delete_table(u'Quiniela_perfil')


        # Changing field 'Pronostico.usuario'
        db.alter_column(u'Quiniela_pronostico', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Quiniela.Usuario']))
