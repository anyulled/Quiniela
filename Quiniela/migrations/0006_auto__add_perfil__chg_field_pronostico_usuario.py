...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'Quiniela_pronostico', 'usuario_id',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Pronostico.usuario'
        db.alter_column(u'Quiniela_pronostico', 'usuario_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Quiniela.Usuario']))
    ...
    models = {
        ...
        u'Quiniela.pronostico': {
            'Meta': {'ordering': "['partido']", 'unique_together': "(('partido', 'usuario'),)",
                     'object_name': 'Pronostico'},
