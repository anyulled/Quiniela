...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Partido.partido_jugado'
        db.add_column(u'Quiniela_partido', 'partido_jugado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partido.partido_jugado'
        db.delete_column(u'Quiniela_partido', 'partido_jugado')
