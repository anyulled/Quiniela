...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partido.goles_penalty_equipo_a'
        db.add_column(u'Quiniela_partido', 'goles_penalty_equipo_a',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Partido.goles_penalty_equipo_b'
        db.add_column(u'Quiniela_partido', 'goles_penalty_equipo_b',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partido.goles_penalty_equipo_a'
        db.delete_column(u'Quiniela_partido', 'goles_penalty_equipo_a')

        # Deleting field 'Partido.goles_penalty_equipo_b'
        db.delete_column(u'Quiniela_partido', 'goles_penalty_equipo_b')
    ...
    models = {
        ...
        u'Quiniela.partido': {
            ...
            'goles_penalty_equipo_a': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'goles_penalty_equipo_b': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
