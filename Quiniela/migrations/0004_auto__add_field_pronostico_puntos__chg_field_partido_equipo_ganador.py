...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'Quiniela_partido', 'equipo_ganador_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['Quiniela.Equipo']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Partido.equipo_ganador'
        db.alter_column(u'Quiniela_partido', 'equipo_ganador_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Quiniela.Equipo']))
