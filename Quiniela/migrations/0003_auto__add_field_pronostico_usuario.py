...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Pronostico.usuario'
        db.add_column(u'Quiniela_pronostico', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Quiniela.Usuario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pronostico.usuario'
        db.delete_column(u'Quiniela_pronostico', 'usuario_id')
