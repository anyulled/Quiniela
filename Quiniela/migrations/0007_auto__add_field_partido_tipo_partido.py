...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Partido.tipo_partido'
        db.add_column(u'Quiniela_partido', 'tipo_partido',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partido.tipo_partido'
        db.delete_column(u'Quiniela_partido', 'tipo_partido')
