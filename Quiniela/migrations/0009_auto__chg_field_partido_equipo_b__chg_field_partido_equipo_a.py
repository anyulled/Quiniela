...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Partido.equipo_b'
        db.alter_column(u'Quiniela_partido', 'equipo_b_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['Quiniela.Equipo']))

        # Changing field 'Partido.equipo_a'
        db.alter_column(u'Quiniela_partido', 'equipo_a_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['Quiniela.Equipo']))

    def backwards(self, orm):

        # Changing field 'Partido.equipo_b'
        db.alter_column(u'Quiniela_partido', 'equipo_b_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Quiniela.Equipo']))

        # Changing field 'Partido.equipo_a'
        db.alter_column(u'Quiniela_partido', 'equipo_a_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['Quiniela.Equipo']))
